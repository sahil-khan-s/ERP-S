  ...
  <input type="checkbox" className="sc-gJwTLC ikxBAC"/>
          ...
          <div className="flex justify-between items-center border-b pb-4">
            <div>
              ...
              <p className="text-sm text-gray-600">Receive push notification</p>
            </div>
            <div className="checkbox-wrapper-2">
  <input type="checkbox" className="sc-gJwTLC ikxBAC"/>
</div>          </div>
          ...
          <div className="flex justify-between items-center border-b pb-4">
            <div>
              ...
              <p className="text-sm text-gray-600">Receive push notification in desktop</p>
            </div>
            <div className="checkbox-wrapper-2">
  <input type="checkbox" className="sc-gJwTLC ikxBAC"/>
</div>          </div>
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600">Receive email notification</p>
            </div>
            <div className="checkbox-wrapper-2">
  <input type="checkbox" className="sc-gJwTLC ikxBAC"/>
</div>
