            ...
            <div className="flex justify-between items-center mt-10">
                ...
                <button onClick={() => setOpenContractPopUp(true)} className="flex justify-between gap-x-2 bg-[#DDFF8F] items-center p-4  h-14 rounded-2xl">
                    ...
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.49976 7.5V13.5M12.4998 10.5H6.49976M9.49976 18C13.6419 18 16.9998 14.6421 16.9998 10.5C16.9998 6.35786 13.6419 3 9.49976 3C5.35762 3 1.99976 6.35786 1.99976 10.5C1.99976 14.6421 5.35762 18 9.49976 18Z" stroke="black" stroke-width="1.5875" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
