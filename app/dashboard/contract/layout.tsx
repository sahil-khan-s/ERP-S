...
const layout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="bg-white p-5 min-h-screen">
      ...
      {openContractPopUp ? (
        <NewContract setOpenContractPopUp={setOpenContractPopUp} />
      ) : null}
      ...
      <div className="flex justify-between items-center mt-10">
          ...
          <div className="flex justify-between min-w-[359px] items-center p-4 border-gray-500 h-14 rounded-2xl border-[0.48px]">
            ...
            >
              <g clipPath="url(#clip0_1_471)">
                <path
                  d="M12.0181 11.2302L14.8752 14.0874"
                  stroke="black"
                  stroke-opacity="0.6"
                ...
                />
                <path
                  d="M13.6053 7.1032C13.6053 3.94729 11.047 1.38892 7.89104 1.38892C4.73513 1.38892 2.17676 3.94729 2.17676 7.1032C2.17676 10.2591 4.73513 12.8175 7.89104 12.8175C11.047 12.8175 13.6053 10.2591 13.6053 7.1032Z"
                  stroke="black"
                  stroke-opacity="0.6"
                  stroke-width="1.42857"
                  stroke-linejoin="round"
              ...
              <defs>
                <clipPath id="clip0_1_471">
                  <rect
                    ...
                    height="15.2381"
                    fill="white"
                    transform="translate(0.906738 0.119141)"
                  />
                </clipPath>
              </defs>
            </svg>
            <input
              className="w-60 placeholder:text-black placeholder:font-light placeholder:font-outfit font-outfit placeholder:text-sm text-black font-light text-sm outline-none"
              type="text"
        ...
        <button
          onClick={() => setOpenContractPopUp(true)}
          className="flex justify-between gap-x-2 bg-[#DDFF8F] items-center p-4  h-14 rounded-2xl"
        >
          <p className="text-black font-outfit font-light text-sm capitalize">
            Add new Contract
          </p>
          ...
          >
            <path
              d="M9.49976 7.5V13.5M12.4998 10.5H6.49976M9.49976 18C13.6419 18 16.9998 14.6421 16.9998 10.5C16.9998 6.35786 13.6419 3 9.49976 3C5.35762 3 1.99976 6.35786 1.99976 10.5C1.99976 14.6421 5.35762 18 9.49976 18Z"
              stroke="black"
              stroke-width="1.5875"
              stroke-linecap="round"
              stroke-linejoin="round"
