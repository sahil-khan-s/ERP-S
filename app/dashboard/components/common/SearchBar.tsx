  ...
  return (
    <div className="flex gap-x-2 lg:gap-x-5">
                    ...
                    <div className="flex justify-between w-150px lg:min-w-[359px] items-center p-4 border-gray-300 h-8 lg:h-14 rounded-lg lg:rounded-2xl border-[0.48px] lg:border">
                        ...
                        <input className="w-24 lg:w-60 placeholder:text-black placeholder:font-light placeholder:font-outfit font-outfit placeholder:text-sm text-black font-light text-sm outline-none" type="text" placeholder="Search by name, role, department..." />
                    ...
                    <button className="flex justify-between gap-x-1 lg:gap-x-2 items-center p-2 lg:p-4 border-gray-300 h-[34px] lg:h-14 rounded-lg lg:rounded-2xl border-[0.48px] lg:border w-16 lg:w-auto">
                        <p className="text-black font-outfit font-light text-[12px] lg:text-sm capitalize">filter</p>
                       <div ><CgFormatCenter className='text-sm lg:text-xl text-gray-500 font-boold'/> </div>
                    </button>
                </div>
  )
}
