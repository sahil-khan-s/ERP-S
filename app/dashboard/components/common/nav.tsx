...
>>>>>>> 2d801f0db394dea4f3049af09a28f51348f7541c
  ...
  return (
    <div className="flex justify-between pt-5">
      ...
      <div className="flex items-center gap-3 lg:gap-8 lg:px-4">
        <Link className="block md:hidden" href="/dashboard/setting">
          <div >
            <svg
              width="26"
              height="26"
        ...
        <Link className="hidden md:block" href="/dashboard/setting">
          <div >
            <svg
              width="39"
              height="39"
        ...
        <Link className=" block md:hidden" href="/dashboard/notification">
        ...
        <Link className="hidden md:block" href="/dashboard/notification">
          <div className="relative">
            <svg
              width="23"
              height="24"
            ...
            <div>
              {profile ? (
                ...
                <AccountCircleSharpIcon
                  style={{ fontSize: "50px" }}
                  className="text-[40px] w-10 h-10 lg:h-12 lg:w-12 "
                />
              )}
            </div>
