...
export default function Nav() {
    ...
    return (
        ...
        <div className="flex justify-between pt-5">
            <div>
                <h1 className="p-3 px-5 text-[19px]">Welcome back , <span className="font-medium">{user?.name}</span></h1>
            </div>
            ...
            <div className="flex items-center gap-8 px-4">
                ...
                <div>
                    <div className="flex items-center pl-4 space-x-2">
                        ...
                        <div>
                            {profile ? (
                                <Image src={profile} className='rounded-full w-[50px] h-[50px]' alt="Profile Picture" width={50} height={50} />
                            ) : (
                            ...
                            <Box sx={{ bgcolor: 'background.paper', borderRadius: '8px' }}>
                                <List sx={{ pt: 0 }}>
                                    <Link href="/dashboard/editProfile">
                                        <ListItemButton onClick={() => { handleModalClose(); }}>
                                            <ListItemIcon>
                                                <PersonOutlineIcon />
                                            </ListItemIcon>
