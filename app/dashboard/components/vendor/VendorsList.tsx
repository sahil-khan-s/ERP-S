      ...
      {vendors ? (
        <table className="rounded overflow-hidden w-full table-auto">
          <thead className="  bg-[#F5F5F5]">
            <tr>
              <th className="px-4 py-5 text-left font-semibold text-nowrap">
                Vendor Name
              </th>
          ...
          {vendors.length !== 0 ? (
            vendors.map((item, index) => (
              <tbody className=" border-b border-slate-100">
                <tr key={index}>
                  ...
                  <td className="p-4">
                    <span className="bg-[#f1f6e7] text-[#6BA10F] px-2 py-1 text-sm rounded-lg">
                      Permanent
                    </span>
                  </td>
                  <td className="flex flex-row justify-center items-center gap-3">
                    <Popover>
                      <PopoverTrigger>
                        <button className="text-slate-600 hover:text-black text-lg">
                          <RiEyeLine />
                        </button>
                      </PopoverTrigger>
                        ...
                        <div>
                          <div className="flex flex-row gap-4 mt-4">
                            ...
                            <div className="flex flex-col gap-1">
                              <div className="gap-2">
                                <div className="text-md font-medium text-gray-500 text-nowrap flex flex-row">
                                  <TiBriefcase className="text-2xl" />
                                  <p>Vendor Name: </p>
                                </div>
                                <div className="text-md text-black font-semibold px-2">
                                  {item.name}
                                </div>
                              </div>

                              <div className="mt-3 flex flex-row gap-2">
                                <div className="text-md font-medium text-gray-500 text-nowrap">
                                  Email:{" "}
                                </div>
                              ...
                              <p className="mt-3 text-slate-500 font-semibold text-sm inline-flex">
                                Date:{" "}
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>
                            You want to delete {item.name} vendor?
                          </AlertDialogTitle>
                          <AlertDialogDescription>
                            This action will permanently delete {item.name}{" "}
                            vendor data.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
            ...
            <div className="h-52 w-[70vh] absolute left-[40%] items-center">
              <p className="text-center text-nowrap m-24 font-xl font-semibold">
