...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="z-100 w-full sm:w-[60%] bg-transparent overflow-hidden">
        <form
          onSubmit={handleSubmit(onSubmit)}
          className="backgroundColor flex flex-col space-y-4 custom-form  bg-transparent px-4 py-8 sm:px-16 border-0"
        >
          <div className="flex flex-col items-center justify-center border-b border-gray-200  bg-transparent px-4 text-center sm:px-16">
            <h3 className="font-bold text-4xl md:text-[60px] mt-0 md:mb-[25px] md:mt-[9px]">Create an Account</h3>
          ...
          <div className="pt-10">
            ...
            {
              loading ? <div className='bg-black rounded-md flex justify-center items-center sm:w-[616px] h-[61px] mx-auto w-full md:w-[616px] border transition-all focus:outline-none'>
          ...
          <p className="text-center text-sm text-gray-600 pt-7">
